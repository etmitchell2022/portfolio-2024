...
const Home = () => {
  return (
    <div className="min-w-full min-h-screen bg-custom-bg flex flex-col items-center">
      {/* Sticky Map */}
      <div className="sticky top-0 z-0 h-[220px] w-[48rem]">
        <CustomMap />
      ...
      <div className="relative z-20 w-full bg-custom-bg">
        <div className="w-[48rem] mx-auto px-4 py-8">
          {/* Header Section */}
          <div className="pb-8">
          ...
          <div className="mt-8">
            ...
            <div className="py-2">
              <p className="text-gray-200 text-sm leading-8 font-sans">
                ...
                across multiple industries. This includes building an app for a
                major airline that is used on 1,000+ flights daily by pilots and
                flight attendants, as well as creating a platform in the
